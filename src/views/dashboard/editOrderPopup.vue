...
<script>
    ...
    export default {
        ...
        mounted() {
            this.sendParam.id = this.$store.getters['orders/getOrder'].id;
        ...
        methods: {
            ...
            submit() {
                ...
                this.sendParam.time_limit = (newDateSeconds - oldDateSeconds) / 1000;
                this.$store.dispatch("controls/" + types.EDIT_TIME_LIMIT, this.sendParam)
                    .then( () => {
